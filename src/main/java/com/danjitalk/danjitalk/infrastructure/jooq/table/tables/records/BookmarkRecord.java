...
public class BookmarkRecord extends UpdatableRecordImpl<BookmarkRecord> implements Record7<Long, LocalDateTime, LocalDateTime, Long, Long, String, Long> {
    ...
    /**
     * Setter for <code>danjitalk.bookmark.type</code>.
     */
    ...
    /**
     * Getter for <code>danjitalk.bookmark.type</code>.
     */
    ...
    /**
     * Setter for <code>danjitalk.bookmark.type_id</code>.
     */
    ...
    /**
     * Getter for <code>danjitalk.bookmark.type_id</code>.
     */
    ...
    @Override
    public Row7<Long, LocalDateTime, LocalDateTime, Long, Long, String, Long> valuesRow() {
    ...
    public Field<Long> field7() {
        return Bookmark.BOOKMARK.TYPE_ID;
    }
    ...
    @Override
    public BookmarkRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, Long value4, Long value5, String value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BookmarkRecord(Long id, LocalDateTime createdAt, LocalDateTime updatedAt, Long feedId, Long memberId, String type, Long typeId) {
        super(Bookmark.BOOKMARK);
