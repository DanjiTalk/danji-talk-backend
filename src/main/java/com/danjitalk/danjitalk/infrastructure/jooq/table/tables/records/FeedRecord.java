...
public class FeedRecord extends UpdatableRecordImpl<FeedRecord> implements Record13<Integer, Integer, Long, LocalDateTime, Long, Long, LocalDateTime, String, String, String, String, String, Integer> {
    ...
    /**
     * Setter for <code>test.feed.bookmark_count</code>.
     */
    ...
    /**
     * Getter for <code>test.feed.bookmark_count</code>.
     */
    ...
    @Override
    public Row13<Integer, Integer, Long, LocalDateTime, Long, Long, LocalDateTime, String, String, String, String, String, Integer> valuesRow() {
    ...
    @Override
    public FeedRecord value13(Integer value) {
        setBookmarkCount(value);
        return this;
    }

    @Override
    public FeedRecord values(Integer value1, Integer value2, Long value3, LocalDateTime value4, Long value5, Long value6, LocalDateTime value7, String value8, String value9, String value10, String value11, String value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FeedRecord(Integer commentCount, Integer reactionCount, Long apartmentId, LocalDateTime createdAt, Long id, Long memberId, LocalDateTime updatedAt, String fileUrl, String thumbnailFileUrl, String title, String contents, String feedType, Integer bookmarkCount) {
        super(Feed.FEED);
